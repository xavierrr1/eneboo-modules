...
/** @class_declaration revOficial */
/////////////////////////////////////////////////////////////////
//// REVOFICIAL ////////////////////////////////////////////////
class revOficial extends oficial {
    function revOficial( context ) { oficial ( context ); }
    function dameTipoBienes(idAsiento:String):String { 
        return this.ctx.revOficial_dameTipoBienes(idAsiento); 
    }
}
//// REVOFICIAL ////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
//// FRAS IMPORT ////////////////////////////////////////////////
class frasImport extends revOficial {
    function frasImport( context ) { revOficial ( context ); }
    function dameTipoBienes(idAsiento:String):String { 
        return this.ctx.frasImport_dameTipoBienes(idAsiento); 
    }
}
//// FRAS IMPORT ////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
//// ANTICIPOS //////////////////////////////////////////////////
class anticipos extends frasImport {
    function anticipos( context ) { frasImport ( context ); }
    function dameTipoBienes(idAsiento:String):String { 
        return this.ctx.anticipos_dameTipoBienes(idAsiento); 
    }
}
//// ANTICIPOS //////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
//// ENTREGASERVICIOSUE /////////////////////////////////////////
class entregaServiciosUE extends anticipos {
    function entregaServiciosUE( context ) { anticipos( context ); }
    function revisarFacturas():Boolean { 
        return this.ctx.entregaServiciosUE_revisarFacturas(); 
    }
}
//// ENTREGASERVICIOSUE /////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
/** @class_definition revOficial */
/////////////////////////////////////////////////////////////////
//// REVOFICIAL /////////////////////////////////////////////////
/*Revision de la clase oficial para declarar bienes de inversion en facturas rectificativas*/
function revOficial_dameTipoBienes(idAsiento:String):String
{
        var util:FLUtil = new FLUtil;
        ...
        if (corrientes && !inversion) {
            ...
            var idRect = util.sqlSelect("facturasprov","idfacturarect","idasiento="+idAsiento);
                if (idRect && idRect != "") {
                var codRect = util.sqlSelect("facturasprov","codigo","idfactura="+idRect);
                var masInfo:String = "*** Rectifica a la Factura: "+codRect+" ***";

                var dialog:Object = new Dialog;
                dialog.caption = util.translate("scripts","Elegir casilla 303");
                dialog.okButtonText = util.translate("scripts","Aceptar");
                dialog.cancelButtonText = util.translate("scripts","Cancelar");
                var codigoFra = util.sqlSelect("facturasprov","codigo","idasiento="+idAsiento);
                
                var text:Object = new Label;
                text.text = util.translate("scripts", "No se ha podido determinar si la factura %1 \ncorresponde a la compra de bienes corrientes o de inversión.\n%2\nElija a continuación el tipo de bienes al que hace relación.\n\nSi elige la opción Indefinido la factura no será incluida de forma automática en el modelo").arg(codigoFra).arg(masInfo);
                
                dialog.add(text);
                var bgroup:GroupBox = new GroupBox;
                dialog.add(bgroup);
                
                var rbCorrientes:Object;
                rbCorrientes = new RadioButton;
                bgroup.add(rbCorrientes);
                rbCorrientes.text = "Bienes Corrientes";
                
                var rbInversion:Object;
                rbInversion = new RadioButton;
                bgroup.add(rbInversion);
                rbInversion.text = "Bienes de Inversión";
                
                var rbIndefinido:Object;
                rbIndefinido = new RadioButton;
                bgroup.add(rbIndefinido);
                rbIndefinido.text = "Indefinido";

                dialog.exec();
                
                if (rbCorrientes.checked) valor = "corrientes";
                if (rbInversion.checked) valor = "inversion";
                if (rbIndefinido.checked) valor = "indefinido";
            }
        }
        return valor;
}
...
/////////////////////////////////////////////////////////////////
//// FRAS IMPORT ////////////////////////////////////////////////
function frasImport_dameTipoBienes(idAsiento:String):String
{
        var util:FLUtil = new FLUtil;
        ...
        if (corrientes && !inversion) {
            ...
            var idRect = util.sqlSelect("facturasprov","idfacturarect","idasiento="+idAsiento);
            var idImport = util.sqlSelect("facturasprov","idfacturaimport","idasiento="+idAsiento);
            if ((idRect && idRect != "") || (idImport && idImport != "")) {
                var tipoRI:String;
                var codRI:String;
                var masInfo:String;
                if (idRect && idRect != "") {
                    tipoRI = "Rectifica la Factura";
                    codRI = util.sqlSelect("facturasprov","codigo","idfactura="+idRect);
                }else if (idImport && idImport != "") {
                    tipoRI = "Iva de Importación de Factura";
                    codRI = util.sqlSelect("facturasprov","codigo","idfactura="+idImport);
                }
                masInfo = "*** "+tipoRI + ": " +codRI+" ***";
...
/////////////////////////////////////////////////////////////////
//// ANTICIPOS //////////////////////////////////////////////////
function anticipos_dameTipoBienes(idAsiento:String):String
{
    var util:FLUtil = new FLUtil;
debug("1 function anticipos_dameTipoBienes");
    var qryTB:FLSqlQuery = new FLSqlQuery;
    qryTB.setTablesList("co_partidas");
    qryTB.setSelect("codsubcuenta");
    qryTB.setFrom("co_partidas");
    ...
    debug("2 function anticipos_dameTipoBienes");
    var valor:String = "indefinido";
    if (corrientes && !inversion) {
            valor = "corrientes";
    } else if (!corrientes && inversion) {
        ...
        debug("ni corrientes ni inversion");
        var idRect = util.sqlSelect("facturasprov","idfacturarect","idasiento="+idAsiento);
        var idImport = util.sqlSelect("facturasprov","idfacturaimport","idasiento="+idAsiento);
        var serieAnt = util.sqlSelect("series","codserie","anticipo is true");
        var serieFact = util.sqlSelect("facturasprov","codserie","idasiento="+idAsiento);
    
        if ((idRect && idRect != "") || (idImport && idImport != "") || (serieAnt && serieAnt == serieFact)) {
            var tipoRI:String;
            var codRI:String;
            var masInfo:String;
            if (idRect && idRect != "") {
                ...
                tipoRI = "Iva de Importación de Factura";
                codRI = util.sqlSelect("facturasprov","codigo","idfactura="+idImport);
            } else if (serieAnt && serieAnt == serieFact) {
                tipoRI = "Factura de Anticipo";
                codRI = util.sqlSelect("facturasprov","codigo","idasiento="+idAsiento);
            }
            masInfo = "*** "+tipoRI + ": " +codRI+" ***";
debug("masInfo="+masInfo);
            var dialog:Object = new Dialog;
            dialog.caption = util.translate("scripts","Elegir casilla 303");
            dialog.okButtonText = util.translate("scripts","Aceptar");
            dialog.cancelButtonText = util.translate("scripts","Cancelar");
...
/////////////////////////////////////////////////////////////////
//// ENTREGASERVICIOSUE /////////////////////////////////////////
function entregaServiciosUE_revisarFacturas():Boolean
{
    
    if (!this.iface.__revisarFacturas()){
        return false;
    }
    ...
    var whereFacturas:String = "a.codejercicio = '" + codEjercicio + "' AND a.fecha BETWEEN '" + fechaDesde + "' AND '" + fechaHasta + "' AND excluir303 <> true and s.idcuentaesp = 'IVARES'";
    var qryFacturasCli:FLSqlQuery = new FLSqlQuery();
    with (qryFacturasCli) {
            setTablesList("clientes,facturascli,co_asientos,co_partidas,co_subcuentas");
            setFrom("facturascli f INNER JOIN co_asientos a ON f.idasiento = a.idasiento INNER JOIN co_partidas p ON a.idasiento = p.idasiento INNER JOIN co_subcuentas s ON p.idsubcuenta = s.idsubcuenta");
    ...
    totalPasos = qryFacturasCli.size();
    paso = 0;
    util.createProgressDialog(util.translate("scripts", "Procesando facturas de cliente de Entrega de servicios"), totalPasos);
